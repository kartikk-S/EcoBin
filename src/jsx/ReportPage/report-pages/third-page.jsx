...
function ThirdPage({ formData, handleFormDataChange }) {
    ...
    const handleFileChange = (event) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                ...
                handleFormDataChange({ image: file }); // Update formData with the image
            };
            ...
            <form className="report-page-3-form">
                ...
                <div className="upload-img">
                    <label htmlFor="file" className="custum-file-upload">
                        ...
                        <div className="text">
                            {!imagePreview && <span>Click to upload image</span>}
                        </div>
